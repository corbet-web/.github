...
Thank you for your interest in contributing to material managed by Julian Yves
Richard Corbet ("We" or "Us"). This contributor license agreement
("Agreement") documents the rights granted by individual contributors to Us.

To make this Agreement effective, accept it through the electronic submission
process specified in the Repository's contribution instructions. This is a
legally binding document, so please read it carefully before agreeing to it.
The Agreement may cover contributions to more than one Repository, including a
Repository created after the Effective Date.

## 1. Definitions

"Repository" means a source-code, documentation, or other content repository
managed by Us whose contribution instructions incorporate this exact version of
the Agreement.
...
Copyright in the entire work of authorship, follow the third-party material
...
parties. When this Agreement covers more than one Repository, the Material means
the work of authorship to which the Contribution was Submitted. After You Submit
the Contribution, it may be included in the Material.
...
rights infringes such patent claims and is conditioned upon compliance with
Section 2.3.

### 2.3 Outbound License

Based on the grant of rights in Sections 2.1 and 2.2, if We include Your
Contribution in Material, We may license the Contribution under any license,
...
employee, You have had Your employer approve this Agreement or accept an entity
contributor agreement. If You are less than eighteen years old, have Your parent
or guardian accept the Agreement.

(d) You have followed the Repository's third-party material instructions if You
...
OF THIS AGREEMENT REGARDLESS OF THE LEGAL OR EQUITABLE THEORY, WHETHER CONTRACT,
...
laws of Switzerland, excluding its conflicts of law provisions. The United
...
The pull-request record specified by the Repository's contribution instructions,
including the contributor's account identity, exact affirmation, timestamp, and
submitted Contribution, is the acceptance record.

## Template provenance

This Agreement uses the copyright-license form and unrestricted outbound-license
selection from the [Harmony Contributor Agreement Template
1.0](https://www.harmonyagreements.org/agreements). Repository-neutral
definitions, electronic acceptance, governing law, and Markdown formatting have
been completed for organization-wide use.

The Harmony template is licensed under the [Creative Commons Attribution 3.0
